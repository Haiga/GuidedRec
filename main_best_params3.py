...
from tfrankmain_multipledrop_risk_menor import LocalEval
                                ...
                                for eval_ideal_risk in [True]:
                                    ...
                                    for dataset in ["ml1m"]:
                                        for LR in [0.0005, 0.0001]:
                                            for EMD_SIZE in [30, 60, 100]:
                                                # LR = 0.0005
                                                for drop_rate in [0.05]:
                                                    list_of_args = [num_baseline_dropouts, local_losfun, add_l2_reg_on_risk,
                                                                    add_loss_on_risk,
                                                                    alpha_risk,
                                                                    do_diff_to_ideal_risk, eval_ideal_risk, dataset, LR, LOSSFUN, drop_rate, EMD_SIZE, id]
